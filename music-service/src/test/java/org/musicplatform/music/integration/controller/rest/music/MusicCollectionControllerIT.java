package org.musicplatform.music.integration.controller.rest.music;
...
import org.musicplatform.music.support.fixture.integration.PageResponseTestFixture;
...
import static org.musicplatform.music.support.assertions.AlbumAssertions.assertAlbumsResponse;
import static org.musicplatform.music.support.assertions.ApiErrorAssertions.assertApiErrorResponse;
import static org.musicplatform.music.support.assertions.ApiErrorAssertions.assertApiErrorResponseStructure;
import static org.musicplatform.music.support.assertions.PageAssertions.*;
import static org.musicplatform.music.support.assertions.SoundAssertions.assertSoundsResponse;
...
public class MusicCollectionControllerIT extends AbstractSpringBootIT {
    ...
    void shouldReturnFirstPageOfCollectionTracks() throws Exception{
        ...
        sounds.forEach(sound -> soundLikeRepository.save(MusicFactoryIT.soundLike(userId, sound)));
    ...
    void shouldReturnFirstPageOfCollectionAlbums() throws Exception{
        ...
        albums.forEach(album -> albumLikeRepository.save(MusicFactoryIT.albumLike(userId, album)));
